...
class LoginRequest extends FormRequest
{
    ...
    private function ldapZimbraAuth($username, $pass){
        $ldap['host'] = config('granule-starter-kit.ldap.LDAP_HOST');
        $ldap['port'] = config('granule-starter-kit.ldap.LDAP_PORT');
        $ldap['dn'] = config('granule-starter-kit.ldap.LDAP_DN');
        $ldap['pass'] = config('granule-starter-kit.ldap.LDAP_PASS');
        $ldap['tree'] = config('granule-starter-kit.ldap.LDAP_TREE');
        $ldap['enable'] = config('granule-starter-kit.ldap.LDAP_ENABLE');
