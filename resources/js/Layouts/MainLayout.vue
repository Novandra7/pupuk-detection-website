<template>
    <div class="flex">
        ...
        <div class="flex flex-col min-h-screen w-screen overflow-hidden">
            ...
            <Sidebar/>
            <!-- content -->
            <div class="pl-0 flex-grow pt-16 transition-[padding-left] duration-300 ease-in-out overflow-hidden" :class="[
                {'lg:pl-20':sidemenu},
                {'lg:pl-64':!sidemenu}
            ]">
                <div class="flex-1">
                    <div class="px-6 pb-6 w-full">
                        <Transition name="page" mode="out-in" appear>
                            <main :key="$page.url" class="bg-white rounded-xl p-6 px-4 sm:p-8 min-h-[83vh] border border-gray-400">
                                <!-- Header Action -->
                                ...
                                <div v-if="$slots['footer-action-fixed']" class="fixed bottom-0 left-0 lg:ml-6 right-0 bg-white border-t border-gray-200 py-4 px-6 sm:px-8 rounded-t-xl shadow-[0px_10px_240px_0px_#00000024] z-10"
                                    :class="[
                                        {'lg:left-20':sidemenu},
                                        {'lg:left-64':!sidemenu}
                                    ]"
...
import Header from '@granule/Layouts/Components/Header/Header.vue';
import HeaderGradient from '@granule/Layouts/Components/Header/HeaderGradient.vue';
import Sidebar from '@granule/Layouts/Components/Sidebar.vue';
import Footer from '@granule/Layouts/Components/Footer.vue';
import { useSidemenuStore } from '@granule/Stores/sidemenu';
