<template>
    ...
    <MainLayout title="Role & Permission">
                        ...
                        <Transition name="fadetransition" mode="out-in" appear>
                            ...
                            <div v-else class="flex flex-col">
                                <div class="flex flex-row justify-between items-center mb-4">
                                    ...
                                    <div>
                                        <el-dropdown trigger="click" placement="bottom-end" v-if="can('role.update|role.delete') && selectedRole.id != 1">
                                            ...
                                            <div class="bg-white rounded-lg p-4 mx-2 mb-2 shadow-md" v-for="permissionList,permissionGroupName in rolePermissions">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <el-switch
                                                        ...
                                                        :active-value="1"
                                                        :inactive-value="0"
                                                        @change="(newValue)=>permissionList.forEach(function (permission) {permission.role_has_permission = newValue; onSwitchChange(selectedRole.id, permission, newValue)})"
        ...
        <el-dialog v-model="dialogFormRoleVisible" width="500px" :append-to-body="true" :destroy-on-close="true"
            ...
            <el-form ref="formUserRoleRef" @submit.prevent="!editMode ? addUserRoleSubmitAction() : editUserRoleSubmitAction()" :model="formUserRole" label-width="200px" label-position="top"
...
import BsLoading from '@granule/Components/BsLoading.vue';
import MainLayout from '@/Layouts/MainLayout.vue';
import { Head, usePage, router, useForm } from '@inertiajs/vue3';
import { ref, computed, reactive } from 'vue';
import { ElMessage, ElMessageBox } from 'element-plus';
import { can } from '@granule/Core/Helpers/permission-check';
import BsProfilePicture from '@granule/Components/BsProfilePicture.vue';
