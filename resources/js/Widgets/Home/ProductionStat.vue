    ...
    <div class="p-4 rounded-xl border border-gray-400 relative overflow-hidden">
        <div class="flex flex-row justify-between items-center">
            <div class="relative z-10">
                <div class="font-semibold text-sm sm:text-base text-gray-700">Production</div>
                <h1 class="font-bold text-xl sm:text-3xl my-1">{{ value }} Ton</h1>
...
onMounted(() => {
    ...
    series.fill = am4core.color("#cb3a31");
